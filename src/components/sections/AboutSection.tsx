...
const features = [
  { icon: Home, title: "63 Oda", desc: "Standart & Suite" },
  { icon: MapPin, title: "Merkezi Konum", desc: "Marina karşısı" },
  { icon: Smile, title: "Misafir Memnuniyeti", desc: "Yüksek puanlı hizmet" },
  { icon: Sun, title: "Deniz Manzarası", desc: "Ege'nin eşsiz güzelliği" },
];
          ...
          <ScrollReveal direction="right">
            <div>
              ...
              <p className="text-text-light text-base leading-8">
                Marina karşısındaki eşsiz konumumuz sayesinde hem şehrin canlı
                atmosferinden hem de denizin dinlendirici huzurundan
                yararlanabilirsiniz.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
                {features.map((f) => (
                  <div key={f.title} className="flex items-start gap-4">
                    <div className="w-11 h-11 min-w-[2.75rem] flex items-center justify-center bg-cream text-accent">
                      <f.icon size={20} />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold tracking-[1px] uppercase text-primary mb-1">
                        {f.title}
                      </h4>
