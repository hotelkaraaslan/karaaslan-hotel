...
export default function KusadasiSection({ places, settings }: KusadasiSectionProps) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-20 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-10">
                {places.map((place) => (
                  <div
                    key={place.id}
                    className="p-5 bg-cream hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] transition-all"
                  >
                    <h4 className="text-xs font-bold uppercase tracking-[1px] text-primary mb-1">
                      {place.title}
                    </h4>
          ...
          <ScrollReveal direction="right">
            <div className="relative w-full h-[400px] lg:h-[500px]">
              <Image
                src={
                  settings.kusadasi_image ||
                  "https://images.unsplash.com/photo-1623238913973-21e45cced554?w=800&q=80"
                }
                alt="Kuşadası"
                fill
