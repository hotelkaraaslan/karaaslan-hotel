  ...
  return (
    <>
      <section id="galeri" className="py-24 lg:py-32 bg-primary text-white">
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <ScrollReveal className="text-center mt-12">
            <Link
              href="/galeri"
              className="inline-block px-10 py-4 border-[1.5px] border-white text-white text-xs font-semibold tracking-[3px] uppercase hover:bg-white hover:text-primary transition-all"
            >
              Tüm Galeriyi Gör
            </Link>
          </ScrollReveal>
      ...
      {lightboxSrc && (
        ...
        >
          <button
            className="absolute top-8 right-8 text-white text-3xl hover:text-accent transition-colors bg-transparent border-none cursor-pointer"
            onClick={() => setLightboxSrc(null)}
          >
            <X size={32} />
          </button>
